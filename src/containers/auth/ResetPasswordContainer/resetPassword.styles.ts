...
/*
Estilos específicos del ResetPasswordContainer.
...
de nueva contraseña y confirmación.

Mantienen el mismo patrón visual
utilizado por LoginContainer y
...
export const resetPasswordStyles = {
  ...
  Reutiliza la misma imagen e identidad
  visual del resto del dominio auth.
  */
  page: {
    minHeight: "100vh",
    backgroundImage:
  ...
  */
  ...
  /*
  Bloque mostrado cuando el enlace
